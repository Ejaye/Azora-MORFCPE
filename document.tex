...
\newcommand{\documentType}{project} % specify if dissertation, thesis, project, dissertation proposal, thesis proposal, project proposal 
...
\newcommand{\documentTitle}{ZigBee Controlled Rover for Human Search during Rescue Operations after an Earthquake Calamity} % put tilde (~) between words to indicate non-breaking adjacent words
