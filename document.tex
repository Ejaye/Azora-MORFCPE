...
\defineAuthor{firstname3}{Louie B.}

\newcommand{\documentTitle}{ZigBee controlled Multi Terrain Rover using Android} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{microcontroller, ZigBee, ARDUINO, system, Rover, Terrain, sensor}
